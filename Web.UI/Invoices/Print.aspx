<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="ESolutions.Shopper.Web.UI.Invoices.Print" %>
			...
			<ItemTemplate>
				<div id="invoice">
					<div id="head">
						...
						<div id="row2">
							...
							<div id="data">
								<table cellspacing="2">
									<tbody>
										<tr>
											<td class="caption">Rechnungsnummer</td>
											<td>
												<asp:Label runat="server" ID="InvoiceNumberLabel" />
											</td>
										</tr>
										<tr>
											<td class="caption">Protokollnummer</td>
											<td>
												<asp:Label runat="server" ID="ProtocoleNumberLabel" />
											</td>
										</tr>
										<tr>
											<td class="caption">Rechnungsdatum</td>
											<td>
												<asp:Label runat="server" ID="InvoiceDateLabel" />
											</td>
										</tr>
										<tr>
											<td class="caption">Lieferdatum</td>
											<td>
												<asp:Label runat="server" ID="ShippingDateLabel" />
											</td>
										</tr>
										<tr runat="server" id="UstIdNrRow">
											<td class="caption">UStIdNr</td>
											<td>
												<asp:Label runat="server" ID="UstIdNrLabel" />
											</td>
										</tr>
						...
						<div id="row3">
							<h1>
								<asp:Literal runat="server" ID="TypeOfDocumentLiteral" />
							</h1>
						</div>
						<div>
							<h1>
								<asp:Literal runat="server" ID="InvoiceCopyLiteral" />
							</h1>
						</div>
					</div>
					<div id="body">
						<table id="table" cellpadding="0" cellspacing="0">
							<thead>
								<tr>
									<th class="numbercolumn">Menge</th>
									<th>Artikelnummer</th>
									<th>Bezeichnung</th>
									<th class="numbercolumn">Netto</th>
									<th class="numbercolumn">
										<asp:Literal runat="server" ID="TaxTableHeadLiteral" Text="USt." /></th>
									<th class="numbercolumn">
										<asp:Literal runat="server" ID="GrossTableHeadLiteral" Text="Brutto" /></th>
							...
							<tfoot>
								<tr runat="server" id="TotalNetRow">
					...
					<div id="foot">
						<div>
							...
							<asp:Panel runat="server" ID="BankPanel" CssClass="bank">
